# AeroDrag — Prompt di comando: chat figlia «gateway Pi»
...
## Blocco specifico — gateway Pi

```
Dominio: gateway Pi. Ingerisce dal device/BLE e fa da ponte verso coach/cloud secondo
le interfacce ratificate (session id, timestamp, relay comandi).
TASK: <incarico gateway>
```
